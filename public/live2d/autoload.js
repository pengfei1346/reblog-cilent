...
const live2d_path = "https://api.zouwang.vip/live2d/";
...
$(window).on("load", function() {
    initWidget(live2d_path + "waifu-tips.json", live2d_path + "api");
});
//initWidget第一个参数为waifu-tips.json的路径
//第二个参数为api地址（无需修改）http://www.zouwang.vip/wp-content/themes/Sakura/live2d/api
